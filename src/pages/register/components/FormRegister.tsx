...
export default function FormRegister() {
    ...
    return (
        ...
        <Formik initialValues={INITIAL_VALUE_FORM_REGISTER} validate={values => FormikValidate(values)} onSubmit={(values, { resetForm, setSubmitting }) => handleSubmit(values, resetForm, setSubmitting)}>
            {
